...
public class PasswordHelper {
    ...
    private static int hashIterations = Integer.parseInt(hashIteration);
    ...
    public static String getPwd(String loginPwd, String salt) {
		return new SimpleHash(algorithmName, loginPwd, ByteSource.Util.bytes(salt), hashIterations).toHex();
    }
