...
public enum BankCodeEnum {
    ...
    public static BankCodeEnum getEnum(String enumName) {
        ...
        for (BankCodeEnum bankCodeEnum : enumAry) {
            if (bankCodeEnum.name().equals(enumName)) {
                resultEnum = bankCodeEnum;
                break;
            }
        }
        return resultEnum;
    ...
    public static Map<String, Map<String, Object>> toMap() {
        ...
        for (BankCodeEnum bankCodeEnum : ary) {
            map = new HashMap<String, Object>();
            map.put("desc", bankCodeEnum.getDesc());
            enumMap.put(bankCodeEnum.name(), map);
        }
        return enumMap;
    }
    ...
    public static List toList() {
        ...
        for (BankCodeEnum bankCodeEnum : ary) {
            ...
            map.put("name", bankCodeEnum.name());
            map.put("desc", bankCodeEnum.getDesc());
            list.add(map);
        }
        return list;
