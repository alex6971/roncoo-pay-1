...
public enum BusCategoryEnum {
    ...
    public static BusCategoryEnum getEnum(String enumName) {
        ...
        for (BusCategoryEnum busCategoryEnum : enumAry) {
            if (busCategoryEnum.name().equals(enumName)) {
                resultEnum = busCategoryEnum;
                break;
            }
        }
        return resultEnum;
    ...
    public static Map<String, Map<String, Object>> toMap() {
        ...
        for (BusCategoryEnum busCategoryEnum : ary) {
            Map<String, Object> map = new HashMap<String, Object>();
            String key = busCategoryEnum.name();
            map.put("desc", busCategoryEnum.getDesc());
            enumMap.put(key, map);
        }
        return enumMap;
    }
    ...
    public static List toList() {
        ...
        for (BusCategoryEnum busCategoryEnum : ary) {
            ...
            map.put("name", busCategoryEnum.name());
            map.put("desc", busCategoryEnum.getDesc());
            map.put("minAmount", busCategoryEnum.getMinAmount());
            map.put("maxAmount", busCategoryEnum.getMaxAmount());
            map.put("beginTime", busCategoryEnum.getBeginTime());
            map.put("endTime", busCategoryEnum.getEndTime());
            list.add(map);
        }
        return list;
    }
