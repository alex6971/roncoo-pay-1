...
public interface RpTradeReconciliationService {
     ...
     * @param trxNo 平台交易流水
     */
    void bankMissOrBankFailBaseBank(String trxNo);
     ...
     */
    void platFailBankSuccess(String trxNo, String bankTrxNo);
     ...
     */
    void handleAmountMistake(RpAccountCheckMistake mistake, boolean isBankMore);

    /**
     * 处理手续费不匹配差错（默认以银行为准）
     * @param mistake
     */
    void handleFeeMistake(RpAccountCheckMistake mistake);
