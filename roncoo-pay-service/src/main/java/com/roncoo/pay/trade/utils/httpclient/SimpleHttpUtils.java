...
public class SimpleHttpUtils {
    ...
    public static String urlEncode(String url, String charSet) {
        ...
        String queryString = url.substring(splitIndex + 1);
        ...
        if (queryString.length() > 0) {
            ...
            for (String nameValue : nameValues) {
                ...
                if (index < 0) {
                    ...
                    pvalue = nameValue.substring(index + 1);
                    try {
            ...
            newQueryString = new StringBuilder(newQueryString.substring(0, newQueryString.length() - 1));
        }
        ...
        if (parameters != null && !parameters.isEmpty()) {
            ...
            for (Entry entry : entrySet) {
                try {
                    ...
                    for (Object v : values) {
                        queryString.append(key).append("=").append(URLEncoder.encode(v == null ? "" : v.toString(), charSet)).append("&");
                    }
                } catch (UnsupportedEncodingException e) {
                    throw new IllegalArgumentException("invalid charset : " + charSet);
                }
