...
public class RpTradeReconciliationServiceImpl implements RpTradeReconciliationService {
    ...
    public void platFailBankSuccess(String trxNo, String bankTrxNo) {
        ...
        rpAccountTransactionService.creditToAccount(record.getMerchantNo(), record.getOrderAmount().subtract(record.getPlatIncome()), record.getBankOrderNo(), record.getBankTrxNo(),
