...
public interface RpSettHandleService {
     ...
     * @param codeNum  企业代号
     */
    void dailySettlementCollect(String userNo, Date endDate, int riskDay, String userName);
     ...
     * 结算审核
     */
    void audit(String settId, String settStatus, String remark);

    /**
     * 打款
     */
    void remit(String settId, String settStatus, String remark);
