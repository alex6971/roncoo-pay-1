...
public class AlipaySubmit {
    ...
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        ...
        sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"").append(ALIPAY_GATEWAY_NEW).append("_input_charset=").append(INPUT_CHARSET).append("\" method=\"").append(
				strMethod).append("\">");

		for (String key : keys) {
			String value = (String) sPara.get((String) key);
